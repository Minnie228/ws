...
export default function Home() {
  ...
  return (
    <div className="p-6 bg-blue-100 min-h-screen font-sans">
      {!passwordValidated ? (
        ...
        <>
          ...
          <button onClick={() => setShowBgmInput(!showBgmInput)} className="mb-4 bg-blue-300 hover:bg-blue-400 px-4 py-1 rounded">
            更换BGM
          </button>
          ...
          <div className="mb-4 p-4 bg-white rounded shadow">
            <div className="flex justify-between items-center mb-2">
              <button onClick={() => changeMonth(-1)} className="bg-blue-300 hover:bg-blue-400 px-3 py-1 rounded">上个月</button>
              <h2 className="text-lg">{year} 年 {month + 1} 月</h2>
              <button onClick={() => changeMonth(1)} className="bg-blue-300 hover:bg-blue-400 px-3 py-1 rounded">下个月</button>
            </div>
            <div className="grid grid-cols-7 gap-1">
              ...
              {weeks.flat().map((day, idx) => (
                <div
                  ...
                  className={`h-10 flex items-center justify-center border rounded cursor-pointer ${day ? 'bg-white hover:bg-blue-200' : ''}`}
                >
                  {day || ''}
                </div>
              ))}
            ...
            {selectedDate && (
              <div className="mt-4">
                ...
                <div className="flex gap-2">
                  <button onClick={saveNote} className="bg-blue-300 hover:bg-blue-400 px-4 py-1 rounded">保存</button>
                  <button onClick={deleteNote} className="bg-red-300 hover:bg-red-400 px-4 py-1 rounded">删除</button>
                </div>
              </div>
            )}
          </div>
